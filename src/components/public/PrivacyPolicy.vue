<template>
  <section id="privacy-policy">
    <v-container>
      ...
      >The words of which the initial letter is capitalized have meanings defined under the following conditions.</p>
      <p
      ...
      >
        <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Community Information Now, NA.
      </p>
      <ul>
        ...
        <li>
          <p >
            <strong>Website</strong>   refers to Somos Neighbors, accessible from   http://www.somosneighbors.com
          </p> 
        </li>
        <li>
          <p >
      ...
      <h2 >
        <a name="Bookmark1"></a>Google Analytics
      </h2>
      <p
        
      >Google Analytics is a web analytics service. Web analysis is the gathering, collection and analysis of data about the behavior of visitors to websites. A web analysis service collects data on which website a data subject has come from, which subpages of the website were accessed or how often and for which period of time a subpage was viewed.</p>
      <p
        
      >Google Analytics uses cookies. The information generated by the cookie about your use of this website is transmitted to a Google server. Google might transfer the personal information collected via this technical procedure to third parties.</p>
      <p
        
      >You can prevent the storage of cookies by a corresponding setting of your browser software; however you may not be able to use all the features of this website to the fullest extent possible.</p>
      <p >
        In addition, you may prevent the collection of the data generated by the cookie and related to your use of the website by Google as well as the processing of this data by Google by downloading and installing the browser plug-in available at the following link:
        <a
          href="https://tools.google.com/dlpage/gaoptout?hl=en"
        >
          <u>https://tools.google.com/dlpage/gaoptout?hl=en</u>
        </a>
      </p>
      <p
        
      >This browser add-on informs Google Analytics that no data and information about website visits may be transmitted to Google Analytics.</p>
      <p
      ...
      <p align="JUSTIFY" style="margin-top: 0.06in; margin-bottom: 0in; background: #ffffff;">
        <a name="Bookmark2"></a>
      </p>
      ...
      <ul>
        ...
        <li>
          <p >
            <strong>To   contact You:</strong> To contact You by   email regarding updates or informative   communications related to the functionalities, products or   contracted services, including the security updates, when necessary   or reasonable for their implementation.
          </p> 
        </li>
        <li>
          <p >
      ...
      <ul>
        ...
        <li>
          ...
          >Prevent   or investigate possible wrongdoing in connection with the Service</p> 
        </li>
        <li>
          <p
      ...
      >This site is not intended for or designed for individuals under the age of 16. We do not knowingly collect information from any person under the age of 16.</p>
      <p
        align="LEFT"
      ...
      <ul>
        ...
        <li>
          <p >
            <a name="Bookmark3"></a>  By email: info@somosneighbors.com
          </p>
        </li>
      </ul>
    </v-container>
